...
# Gitignored. Need onlyfor build.
BUILD_ASSETS_DIR = "build_assets" 

# directory containing repacked chromium. Included in Nuitka build.
VENDOR_DIR = "vendor" 

# directory where chromium will be unpacked in runtime
CHROMIUM_DIR = "chromium-bin" 

# NB: We repack сhromium while building the application image mainly for two reasons: 
...
ASSETS = {
    # Have to use binary unarchiver beacuse at the moment BCJ2 filter is not supported by py7zr
